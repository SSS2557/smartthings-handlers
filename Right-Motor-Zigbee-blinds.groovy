...
metadata {
	definition(name: "RIGHT MOTOR ORVIBO/Yooksmart/Yoolax Zigbee Window Shades", namespace: "smartthingsHandlers", author: "Sandesh", ocfDeviceType: "oic.d.blind", mnmn: "SmartThings", vid: "generic-shade-3") {
		capability "Actuator"
		capability "Battery"
...
def levelEventHandler(currentLevel) {
	...
	if (lastLevel == "undefined") {
		...
		if (currentLevel == 0 || currentLevel == 100) {
			sendEvent(name: "windowShade", value: currentLevel == 100 ? "closed" : "open")
		} else {
